package testVagrant.qa.rcb.constants;

public class Constants {

    public static final String JSONPATH = System.getProperty("user.dir")+"/src/test/java/testVagrant/qa/rcb/testData/RCB.json";
